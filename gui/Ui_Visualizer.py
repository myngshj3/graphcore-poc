...
class Ui_visualizerDialog(object):
    def setupUi(self, visualizerDialog):
        ...
        self.edgePlotArea = QtWidgets.QGroupBox(visualizerDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.edgePlotArea.sizePolicy().hasHeightForWidth())
        self.edgePlotArea.setSizePolicy(sizePolicy)
        self.edgePlotArea.setObjectName("edgePlotArea")
        self.edgePlotAreaHorizontalLayout = QtWidgets.QHBoxLayout(self.edgePlotArea)
        self.edgePlotAreaHorizontalLayout.setObjectName("edgePlotAreaHorizontalLayout")
        self.frame_13 = QtWidgets.QFrame(self.edgePlotArea)
        ...
        self.edgePlotAreaHorizontalLayout.addWidget(self.frame_13)
        self.edgePlot = PlotWidget(self.edgePlotArea)
        self.edgePlot.setObjectName("edgePlot")
        self.edgePlotAreaHorizontalLayout.addWidget(self.edgePlot)
        self.gridLayout_2.addWidget(self.edgePlotArea, 2, 0, 1, 1)
        ...
        self.stepOffset = QtWidgets.QSpinBox(self.frame_15)
        font = QtGui.QFont()
        font.setFamily("ＭＳ Ｐゴシック")
        self.stepOffset.setFont(font)
        self.stepOffset.setObjectName("stepOffset")
        self.horizontalLayout_4.addWidget(self.stepOffset)
        ...
        self.steps = QtWidgets.QSpinBox(self.frame_15)
        self.steps.setObjectName("steps")
        self.horizontalLayout_4.addWidget(self.steps)
        ...
        self.dt = QtWidgets.QDoubleSpinBox(self.frame_12)
        ...
        self.nodePlotArea = QtWidgets.QGroupBox(visualizerDialog)
        self.nodePlotArea.setObjectName("nodePlotArea")
        self.nodePlotAreaHorizontalLayout = QtWidgets.QHBoxLayout(self.nodePlotArea)
        self.nodePlotAreaHorizontalLayout.setObjectName("nodePlotAreaHorizontalLayout")
        self.frame_5 = QtWidgets.QFrame(self.nodePlotArea)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.nodePlotAreaHorizontalLayout.addWidget(self.frame_5)
        self.nodePlot = PlotWidget(self.nodePlotArea)
        self.nodePlot.setObjectName("nodePlot")
        self.nodePlotAreaHorizontalLayout.addWidget(self.nodePlot)
        self.gridLayout_2.addWidget(self.nodePlotArea, 1, 0, 1, 1)
    ...
    def retranslateUi(self, visualizerDialog):
        ...
        self.edgePlotArea.setTitle(_translate("visualizerDialog", "Edge results"))
        ...
        self.label_8.setText(_translate("visualizerDialog", "Step duration:"))
        ...
        self.nodePlotArea.setTitle(_translate("visualizerDialog", "Node results"))
